<template>
    <v-app-bar color="#2b2d31" height="30" elevation="0">
        <v-btn variant="text" color="grey" to="/"><v-icon>mdi-chevron-left</v-icon> RETURN TO APP</v-btn>
    </v-app-bar>
        <v-main>
            <v-container>
        <h1>Privacy Policy of VatIRIS</h1>

<p>VatIRIS operates the VatIRIS website, which provides the VatIRIS Service.</p>
